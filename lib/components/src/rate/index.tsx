...
export const Rate = ( { size, half, className, ...props }: rateProps ) => {
  return (<groupIdCtx.Provider value={useId()}>
    <div {...props} className={rateProps({ size, half, className })} />
  </groupIdCtx.Provider>)
}
...
const RateItem = ( { hidden, half, className, ...props }: itemProps ) => {
  return (<groupIdCtx.Consumer>
    { (id) => <input {...props} type="radio" name={id} className={itemProps({ hidden: hidden, half, className })} /> }
  </groupIdCtx.Consumer>
  )
}

export const RateStar1: typeof RateItem = ( { className, ...props } ) => {
  return <RateItem {...props} className={cx('mask-star', className)} />
}

export const RateStar2: typeof RateItem = ( { className, ...props } ) => {
  return <RateItem {...props} className={cx('mask-star-2', className)} />
}

export const RateHeart: typeof RateItem = ( { className, ...props } ) => {
  return <RateItem {...props} className={cx('mask-heart', className)} />
}
